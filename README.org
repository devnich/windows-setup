...
** Updating obsolete versions (June 2025)
...
2. Home
   ...
   - New tabs: *Blank page*
3. Home > Firefox Home Content
   - Disable everything except "Web Search"
4. Search > Search suggestions
...
6. Privacy & Security > Passwords
   - Disable everything
7. Privacy & Security > Autofill
   - Disable everything
8. Privacy & Security > Firefox Data Collection
   - Disable everything
...
** COMMENT Python virtual environments (uv)

** COMMENT HPC cluster (MobaXTerm)
...
# pandoc README.org -f org -t gfm -s --wrap=none | pandoc --toc --toc-depth=2 --no-highlight --reference-doc=/Users/gilgamesh/Documents/Templates/custom-reference.docx -o docs/KL330_setup.docx
